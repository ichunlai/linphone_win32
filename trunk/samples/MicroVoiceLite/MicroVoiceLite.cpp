...
// 唯一的一个 CMicroVoiceLiteApp 对象

CMicroVoiceLiteApp theApp;

// CMicroVoiceLiteApp 初始化

BOOL CMicroVoiceLiteApp::InitInstance()
{
