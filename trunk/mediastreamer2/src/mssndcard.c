...
void ms_snd_card_manager_destroy(
    void)
{
    if (scm != NULL)
    {
...
MSSndCardManager *ms_snd_card_manager_get(
    void)
{
...
MSSndCard *ms_snd_card_manager_get_card(
    MSSndCardManager *m, const char *id)
{
    MSList *elem;
...
MSSndCard *ms_snd_card_manager_get_default_card(
    MSSndCardManager *m)
{
...
MSSndCard *ms_snd_card_manager_get_default_capture_card(
    MSSndCardManager *m)
{
    MSList *elem;
    for (elem = m->cards; elem != NULL; elem = elem->next)
...
MSSndCard *ms_snd_card_manager_get_default_playback_card(
    MSSndCardManager *m)
{
    MSList *elem;
    for (elem = m->cards; elem != NULL; elem = elem->next)
...
const MSList *ms_snd_card_manager_get_list(
    MSSndCardManager *m)
{
    return m->cards;
}

void ms_snd_card_manager_add_card(
    MSSndCardManager *m, MSSndCard *c)
{
...
static void card_detect(
    MSSndCardManager *m, MSSndCardDesc *desc)
{
    if (desc->detect != NULL)
        desc->detect(m);
}

void ms_snd_card_manager_register_desc(
    MSSndCardManager *m, MSSndCardDesc *desc)
{
    if (m != NULL && desc != NULL)
    {
...
void ms_snd_card_manager_reload(
    MSSndCardManager *m)
{
    MSList *elem;
...
MSSndCard *ms_snd_card_new(
    MSSndCardDesc *desc)
{
    return ms_snd_card_new_with_name(desc, NULL);
}

MSSndCard *ms_snd_card_new_with_name(
    MSSndCardDesc *desc, const char *name)
{
...
const char *ms_snd_card_get_driver_type(
    const MSSndCard *obj)
{
    return obj->desc->driver_type;
}

const char *ms_snd_card_get_name(
    const MSSndCard *obj)
{
    return obj->name;
}

unsigned int ms_snd_card_get_capabilities(
    const MSSndCard *obj)
{
    return obj->capabilities;
}

MS2_PUBLIC int ms_snd_card_get_minimal_latency(
    MSSndCard *obj)
{
    return obj->latency;
}

const char *ms_snd_card_get_string_id(
    MSSndCard *obj)
{
...
void ms_snd_card_set_level(
    MSSndCard *obj, MSSndCardMixerElem e, int percent)
{
...
int ms_snd_card_get_level(
    MSSndCard *obj, MSSndCardMixerElem e)
{
...
void ms_snd_card_set_capture(
    MSSndCard *obj, MSSndCardCapture c)
{
...
int ms_snd_card_set_control(
    MSSndCard *obj, MSSndCardControlElem e, int val)
{
...
int ms_snd_card_get_control(
    MSSndCard *obj, MSSndCardControlElem e)
{
...
struct _MSFilter *ms_snd_card_create_reader(
    MSSndCard *obj)
{
...
struct _MSFilter *ms_snd_card_create_writer(
    MSSndCard *obj)
{
...
int ms_snd_card_get_preferred_sample_rate(
    const MSSndCard *obj)
{
    return obj->preferred_sample_rate;
}

int ms_snd_card_set_preferred_sample_rate(
    MSSndCard *obj, int rate)
{
...
MSSndCard *ms_alsa_card_new_custom(
...
void ms_alsa_card_set_forced_sample_rate(
    int samplerate)
{
    ms_warning("Alsa support not available in this build of mediastreamer2");
}
