...
static inline float linear_to_db(
    float linear)
{
...
static int volume_set_sample_rate(
    MSFilter *f, void *arg)
{
    Volume *v = (Volume *)f->data;
...
//use our builtin agc
#if 0
static float volume_agc_process(
    Volume *v, mblk_t *om)
{
...
static inline float compute_gain(
    Volume *v, float energy, float weight)
{
...
static float volume_echo_avoider_process(
    Volume *v, mblk_t *om)
{
    static int counter;
...
static void volume_noise_gate_process(
    Volume *v, float energy, mblk_t *om)
{
    static int counter;
...
static int volume_set_db_gain(
    MSFilter *f, void *gain)
{
...
static int volume_set_ea_threshold(
    MSFilter *f, void *arg)
{
    Volume *v  = (Volume *)f->data;
    float  val = *(float *)arg;
...
static int volume_set_ea_transmit_threshold(
    MSFilter *f, void *arg)
{
    Volume *v  = (Volume *)f->data;
    float  val = *(float *)arg;
...
static int volume_set_ea_speed(
    MSFilter *f, void *arg)
{
    Volume *v  = (Volume *)f->data;
    float  val = *(float *)arg;
...
static int volume_set_ea_force(
    MSFilter *f, void *arg)
{
    Volume *v  = (Volume *)f->data;
    float  val = *(float *)arg;
...
static int volume_set_ea_sustain(
    MSFilter *f, void *arg)
{
    Volume *v = (Volume *)f->data;
...
static int volume_enable_noise_gate(
    MSFilter *f, void *arg)
{
    Volume *v = (Volume *)f->data;
...
static int volume_set_noise_gate_threshold(
    MSFilter *f, void *arg)
{
    Volume *v = (Volume *)f->data;
...
static int volume_set_noise_gate_floorgain(
    MSFilter *f, void *arg)
{
    Volume *v = (Volume *)f->data;
...
static inline int16_t saturate(
    int val)
{
...
static void update_energy(
    int16_t *signal, int numsamples, Volume *v)
{
    int   i;
    float acc = 0;
    float en;
...
#if 0
    ms_warning("msvolume time %llu, dur %llu", GetTickCount64() - start, GetTickCount64() - pre);
    pre = GetTickCount64();
#endif
}
