...
MSList *ms_list_append_link(
    MSList *elem, MSList *new_elem)
{
    MSList *it = elem;
...
MSList *ms_list_concat(
    MSList *first, MSList *second)
{
    MSList *it = first;
...
MSList *ms_list_remove(
    MSList *first, void *data)
{
    MSList *it;
...
void ms_list_for_each(
    const MSList *list, void (*func)(void *))
{
...
void ms_list_for_each2(
    const MSList *list, void (*func)(void *, void *), void *user_data)
{
    for (; list != NULL; list = list->next)
    {
...
MSList *ms_list_remove_link(
    MSList *list, MSList *elem)
{
    MSList *ret;
    if (elem == list)
    {
...
MSList *ms_list_find_custom(
    MSList *list, int (*compare_func)(const void *, const void *), const void *user_data)
{
    for (; list != NULL; list = list->next)
    {
...
void *ms_list_nth_data(
    const MSList *list, int index)
{
    int i;
...
int ms_list_position(
    const MSList *list, MSList *elem)
{
    int i;
    for (i = 0; list != NULL; list = list->next, ++i)
    {
...
MSList *ms_list_insert_sorted(
    MSList *list, void *data, int (*compare_func)(const void *, const void *))
{
...
MSList *ms_list_insert(
    MSList *list, MSList *before, void *data)
{
    MSList *elem;
