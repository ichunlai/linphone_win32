...
static inline bool_t
ms_video_size_area_greater_than(
    MSVideoSize vs1,
    MSVideoSize vs2)
{
...
static inline MSVideoOrientation
...
static inline MSVideoSize
ms_video_size_change_orientation(
    MSVideoSize        vs,
