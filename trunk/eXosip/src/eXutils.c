...
int
eXosip_dns_get_local_fqdn(
    char         **servername,
    char         **serverip,
    char         **netmask,
    unsigned int WIN32_interface)
{
    unsigned int pos;
...
static int _eXosip_default_gateway_ipv6(char *address, int size);
        ...
        #include <ifaddrs.h>
static int
_eXosip_default_gateway_with_getifaddrs(
    int  type,
    char *address,
    int  size)
{
...
static void
osip_srv_record_sort(
    struct osip_srv_record *rec,
    int                    n)
{
    int                   i;
    int                   permuts;
...
static int
eXosip_dnsutils_srv_lookup(
    struct osip_naptr *output_record)
{
...
int
_eXosip_dnsutils_srv_lookup(
    struct osip_srv_record *output_srv)
{
