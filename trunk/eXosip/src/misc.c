...
int
eXosip_remove_transaction_from_call(
...
osip_transaction_t *
eXosip_find_last_inc_transaction(
    eXosip_call_t   *jc,
    eXosip_dialog_t *jd,
    const char      *method)
{
...
osip_transaction_t *
eXosip_find_last_out_transaction(
    eXosip_call_t   *jc,
    eXosip_dialog_t *jd,
    const char      *method)
{
