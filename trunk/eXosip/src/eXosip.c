...
static int
_eXosip_retry_with_auth(
    eXosip_dialog_t    *jd,
    osip_transaction_t **ptr,
    int                *retry)
{
...
static int
_eXosip_retry_register_with_auth(
    eXosip_event_t *je)
{
...
static int
_eXosip_retry_invite_with_auth(
    eXosip_event_t *je)
{
...
static int
_eXosip_retry_subscribe_with_auth(
    eXosip_event_t *je)
{
    eXosip_dialog_t    *jd    = NULL;
...
static int
_eXosip_retry_publish_with_auth(
    eXosip_event_t *je)
{
...
static int
_eXosip_retry_notify_with_auth(
    eXosip_event_t *je)
{
    /* TODO untested */
    eXosip_dialog_t    *jd = NULL;
...
static jauthinfo_t *
eXosip_find_authentication_info(
    const char *username,
    const char *realm)
{
...
int
eXosip_add_authentication_information(
    osip_message_t *req,
