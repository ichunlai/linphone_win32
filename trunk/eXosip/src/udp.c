...
static void
eXosip_process_subscribe_within_call(
    eXosip_notify_t    *jn,
    eXosip_dialog_t    *jd,
    osip_transaction_t *transaction,
    osip_event_t       *evt)
...
static void
eXosip_process_notify_within_dialog(
...
static int
eXosip_match_notify_for_subscribe(
    eXosip_subscribe_t *js,
    osip_message_t     *notify)
{
...
static void
eXosip_process_message_within_dialog(
    eXosip_call_t      *jc,
    eXosip_dialog_t    *jd,
    osip_transaction_t *transaction,
    osip_event_t       *evt)
...
static void
eXosip_process_response_out_of_transaction(
    osip_event_t *evt)
{
...
int
_eXosip_handle_incoming_message(
    char   *buf,
    size_t length,
    int    socket,
    char   *host,
...
static int
eXosip_pendingosip_transaction_exist(
    eXosip_call_t   *jc,
    eXosip_dialog_t *jd)
{
    osip_transaction_t *tr;
...
static int
eXosip_release_finished_transactions(
    eXosip_call_t   *jc,
    eXosip_dialog_t *jd)
{
    time_t             now = time(NULL);
...
static int
eXosip_release_finished_transactions_for_subscription(
    eXosip_dialog_t *jd)
{
    time_t             now        = time(NULL);
    osip_transaction_t *inc_tr;
