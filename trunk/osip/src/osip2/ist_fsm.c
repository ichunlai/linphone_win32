...
static void ist_handle_transport_error(
    osip_transaction_t *ist, int err)
{
...
void ist_rcv_invite(
    osip_transaction_t *ist, osip_event_t *evt)
{
    int i;
