...
static void nist_handle_transport_error(
    osip_transaction_t *nist, int err)
{
...
void nist_rcv_request(
    osip_transaction_t *nist, osip_event_t *evt)
{
    int i;
...
void osip_nist_timeout_j_event(
    osip_transaction_t *nist, osip_event_t *evt)
{
