...
void __ict_load_fsm()    // init state machine
{
    transition_t *transition;
...
static void ict_handle_transport_error(
    osip_transaction_t *ict, int err)
{
...
void ict_snd_invite(
    osip_transaction_t *ict, osip_event_t *evt)
{
    int    i;
...
osip_message_t *ict_create_ack(
    osip_transaction_t *ict, osip_message_t *response)
{
    int            i;
    osip_message_t *ack;
