...
struct osip_thread *osip_thread_create(
...
int osip_thread_set_priority(
    struct osip_thread *thread, int priority)
{
    return OSIP_SUCCESS;
}

int osip_thread_join(
    struct osip_thread *_thread)
{
...
int osip_thread_set_priority(
    struct osip_thread *_thread, int priority)
{
