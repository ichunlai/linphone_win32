...
static void nict_handle_transport_error(
    osip_transaction_t *nict, int err)
{
...
void nict_snd_request(
    osip_transaction_t *nict, osip_event_t *evt)
{
    int    i;
...
void osip_nict_timeout_e_event(
    osip_transaction_t *nict, osip_event_t *evt)
{
    osip_t *osip = (osip_t *) nict->config;
    int    i;
...
void osip_nict_timeout_f_event(
    osip_transaction_t *nict, osip_event_t *evt)
{
...
void osip_nict_timeout_k_event(
    osip_transaction_t *nict, osip_event_t *evt)
{
