...
int __osip_nict_init(
    osip_nict_t **nict, osip_t *osip, osip_message_t *request)
{
    osip_route_t *route;
    int          i;
    time_t       now;
...
int osip_nict_set_destination(
    osip_nict_t *nict, char *destination, int port)
{
    if (nict == NULL)
...
osip_event_t *__osip_nict_need_timer_e_event(
    osip_nict_t *nict, state_t state,
    int transactionid)
{
...
osip_event_t *__osip_nict_need_timer_f_event(
    osip_nict_t *nict, state_t state,
    int transactionid)
{
...
osip_event_t *__osip_nict_need_timer_k_event(
    osip_nict_t *nict, state_t state,
    int transactionid)
{
