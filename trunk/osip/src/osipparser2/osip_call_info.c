    ...
    const char       *hvalue)
{
    ...
    if (osip_call_info_params != NULL)
    {
        i = __osip_generic_param_parseall(&call_info->gen_params,
                                          osip_call_info_params);
        if (i != 0)
            return i;
    }
    else
...
osip_call_info_to_str(
    const osip_call_info_t *call_info,
    char                   **dest)
{
    char   *buf;
    char   *tmp;
    ...
    *dest = buf;
...

    {
        ...
        {
            u_param =
                (osip_generic_param_t *) osip_list_get(&call_info->gen_params,
                                                       pos);
    ...
    osip_call_info_t       **dest)
{
    ...
    *dest = NULL;
    ...
    i = osip_list_clone(&ctt->gen_params, &ct->gen_params,
