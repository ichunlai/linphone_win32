 ...
 * given as a string.
 **/
LinphoneAddress *linphone_address_new(
    const char *addr)
{
 ...
 **/
LinphoneAddress *linphone_address_clone(
 ...
 **/
const char *linphone_address_get_scheme(
 ...
 **/
const char *linphone_address_get_display_name(
    const LinphoneAddress *u)
{
 ...
 **/
const char *linphone_address_get_username(
    const LinphoneAddress *u)
{
 ...
 **/
const char *linphone_address_get_domain(
    const LinphoneAddress *u)
{
...
void linphone_address_set_display_name(
    LinphoneAddress *u, const char *display_name)
{
...
void linphone_address_set_username(
    LinphoneAddress *uri, const char *username)
{
...
void linphone_address_set_domain(
    LinphoneAddress *uri, const char *host)
{
...
void linphone_address_set_port(
    LinphoneAddress *uri, const char *port)
{
 ...
 * Sets the port number.
 **/
void linphone_address_set_port_int(
    LinphoneAddress *uri, int port)
{
 ...
 **/
char *linphone_address_as_string(
    const LinphoneAddress *u)
{
 ...
 **/
bool_t linphone_address_weak_equal(
    const LinphoneAddress *a1, const LinphoneAddress *a2)
{
    const char *u1, *u2;
    const char *h1, *h2;
    int        p1, p2;
 ...
 **/
void linphone_address_destroy(
    LinphoneAddress *u)
{
    sal_address_destroy(u);
}

int linphone_address_get_port_int(
    const LinphoneAddress *u)
{
    return sal_address_get_port_int(u);
}

const char *linphone_address_get_port(
    const LinphoneAddress *u)
{
