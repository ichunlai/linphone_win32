 ...
 */
LinphoneChatRoom *linphone_core_create_chat_room(
    LinphoneCore *lc, const char *to)
{
 ...
 */
void linphone_chat_room_destroy(
    LinphoneChatRoom *cr)
{
...
static void _linphone_chat_room_send_message(
    LinphoneChatRoom *cr, LinphoneChatMessage *msg)
{
...
bool_t linphone_chat_room_matches(
    LinphoneChatRoom *cr, const LinphoneAddress *from)
{
...
void linphone_chat_room_message_received(
    LinphoneChatRoom *cr, LinphoneCore *lc, LinphoneChatMessage *msg)
{
    if (msg->message)
        //legacy API
 ...
 **/
LinphoneChatRoom *linphone_core_get_chat_room(
...
void linphone_core_message_received(
    LinphoneCore *lc, SalOp *op, const SalMessage *sal_msg)
{
    LinphoneChatRoom      *cr = NULL;
 ...
 **/
LinphoneCore *linphone_chat_room_get_lc(
    LinphoneChatRoom *cr)
{
    return cr->lc;
}
 ...
 **/
void linphone_chat_room_set_user_data(
    LinphoneChatRoom *cr, void *ud)
{
    cr->user_data = ud;
}
 ...
 **/
void *linphone_chat_room_get_user_data(
    LinphoneChatRoom *cr)
{
    return cr->user_data;
}
 ...
 */
const LinphoneAddress *linphone_chat_room_get_peer_address(
    LinphoneChatRoom *cr)
{
    return cr->peer_url;
}
 ...
 */
LinphoneChatMessage *linphone_chat_room_create_message(
    LinphoneChatRoom *cr, const char *message)
{
...
void linphone_chat_room_send_message2(
    LinphoneChatRoom *cr, LinphoneChatMessage *msg, LinphoneChatMessageStateChangeCb status_cb, void *ud)
{
    msg->cb    = status_cb;
    msg->cb_ud = ud;
...
const char *linphone_chat_message_state_to_string(
    const LinphoneChatMessageState state)
{
    switch (state)
    {
 ...
 **/
LinphoneChatRoom *linphone_chat_message_get_chat_room(
    LinphoneChatMessage *msg)
{
 ...
 **/
const LinphoneAddress *linphone_chat_message_get_peer_address(
    LinphoneChatMessage *msg)
{
 ...
 */
void linphone_chat_message_set_user_data(
    LinphoneChatMessage *message, void *ud)
{
 ...
 */
void *linphone_chat_message_get_user_data(
...
void linphone_chat_message_set_external_body_url(
    LinphoneChatMessage *message, const char *url)
{
...
void linphone_chat_message_set_from(
    LinphoneChatMessage *message, const LinphoneAddress *from)
{
 ...
 */
const LinphoneAddress *linphone_chat_message_get_from(
    const LinphoneChatMessage *message)
{
    return message->from;
}
 ...
 *@return #LinphoneAddress
 */
const LinphoneAddress *linphone_chat_message_get_to(
    const LinphoneChatMessage *message)
{
 ...
 *@return #LinphoneAddress
 */
LinphoneAddress *linphone_chat_message_get_local_address(
    const LinphoneChatMessage *message)
{
 ...
 */
time_t linphone_chat_message_get_time(
    const LinphoneChatMessage *message)
{
    return message->time;
}
 ...
 */
LinphoneChatMessageState linphone_chat_message_get_state(
    const LinphoneChatMessage *message)
{
 ...
 */
const char *linphone_chat_message_get_text(
    const LinphoneChatMessage *message)
{
...
void linphone_chat_message_add_custom_header(
    LinphoneChatMessage *message, const char *header_name, const char *header_value)
{
...
const char *linphone_chat_message_get_custom_header(
    LinphoneChatMessage *message, const char *header_name)
{
 ...
 **/
LinphoneChatMessage *linphone_chat_message_clone(
 ...
 **/
void linphone_chat_message_destroy(
    LinphoneChatMessage *msg)
{
