...
void linphone_core_add_subscriber(
    LinphoneCore *lc, const char *subscriber, SalOp *op)
{
...
void linphone_core_reject_subscriber(
    LinphoneCore *lc, LinphoneFriend *lf)
{
    linphone_friend_set_inc_subscribe_policy(lf, LinphoneSPDeny);
}

void linphone_core_notify_all_friends(
    LinphoneCore *lc, LinphoneOnlineStatus os)
{
    MSList *elem;
...
void linphone_subscription_new(
    LinphoneCore *lc, SalOp *op, const char *from)
{
...
void linphone_notify_recv(
    LinphoneCore *lc, SalOp *op, SalSubscribeStatus ss, SalPresenceStatus sal_status)
{
    char                 *tmp;
    LinphoneFriend       *lf;
...
void linphone_subscription_closed(
