...
//}
//
//gstate_t linphone_core_get_state(
//    const LinphoneCore *lc, gstate_group_t group)
//{
//    switch (group)
//    {
...
//static void linphone_core_set_state(
//    LinphoneCore *lc, gstate_group_t group, gstate_t new_state)
//{
//    switch (group)
//    {
//    case GSTATE_GROUP_POWER:
...
//
//    /* determine the affected group */  // ���P�_�� state �O�ݩ���� group ��
...
//    states_arg.new_state = new_state;                                     // new state
//    states_arg.old_state = linphone_core_get_state(lc, states_arg.group); // old state
//    linphone_core_set_state(lc, states_arg.group, new_state);             // set new state
//    states_arg.message   = message;                                       // message
//
