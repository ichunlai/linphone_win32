...
static bool_t generate_b64_crypto_key(
    int key_length, char *key_out)
{
    int     b64_size;
...
LinphoneCore *linphone_call_get_core(
    const LinphoneCall *call)
{
    return call->core;
}

const char *linphone_call_get_authentication_token(
    LinphoneCall *call)
{
...
static bool_t linphone_call_are_all_streams_encrypted(
    LinphoneCall *call)
{
...
void propagate_encryption_changed(
    LinphoneCall *call)
{
...
#ifdef VIDEO_ENABLED
static void linphone_call_videostream_encryption_changed(
    void *data, bool_t encrypted)
{
...
static void linphone_call_audiostream_encryption_changed(
    void *data, bool_t encrypted)
{
    char         status[255] = {0};
...
static void linphone_call_audiostream_auth_token_ready(
    void *data, const char *auth_token, bool_t verified)
{
    LinphoneCall *call = (LinphoneCall *)data;
...
void linphone_call_set_authentication_token_verified(
    LinphoneCall *call, bool_t verified)
{
...
static void update_media_description_from_stun(
    SalMediaDescription *md, const StunCandidate *ac, const StunCandidate *vc)
{
    int i;
...
void linphone_call_make_local_media_description(
...
static int find_port_offset(
    LinphoneCore *lc, SalStreamType type)
{
    int    offset;
    MSList *elem;
    int    tried_port;
...
static void linphone_call_init_common(
...
void linphone_call_init_stats(
    LinphoneCallStats *stats, int type)
{
    stats->type          = type;
...
static void discover_mtu(
    LinphoneCore *lc, const char *remote)
{
    int mtu;
...
// 發起對外的呼叫
LinphoneCall *linphone_call_new_outgoing(
    struct _LinphoneCore *lc, LinphoneAddress *from, LinphoneAddress *to, const LinphoneCallParams *params)
{
...
LinphoneCall *linphone_call_new_incoming(
    LinphoneCore *lc, LinphoneAddress *from, LinphoneAddress *to, SalOp *op)
{
    LinphoneCall              *call = ms_new0(LinphoneCall, 1);
    char                      *from_str;
...
static void linphone_call_set_terminated(
    LinphoneCall *call)
{
    if (call != NULL)
    {
        ...
        //linphone_call_destroy(call);    // iclai: fix memory leak
    }
}

void linphone_call_fix_call_parameters(
    LinphoneCall *call)
{
...
const char *linphone_call_state_to_string(
    LinphoneCallState cs)
{
    switch (cs)
    {
 ...
 **/
LinphoneCall *linphone_call_ref(
    LinphoneCall *obj)
{
    obj->refcnt++;
    return obj;
 ...
 **/
const LinphoneCallParams *linphone_call_get_current_params(
    LinphoneCall *call)
{
...
static bool_t is_video_active(
    const SalStreamDescription *sd)
{
 ...
 **/
const LinphoneCallParams *linphone_call_get_remote_params(
    LinphoneCall *call)
{
 ...
 **/
char *linphone_call_get_remote_address_as_string(
    const LinphoneCall *call)
{
 ...
 **/
LinphoneReason linphone_call_get_reason(
    const LinphoneCall *call)
{
    return call->reason;
}
 ...
 **/
void *linphone_call_get_user_pointer(
    LinphoneCall *call)
{
 ...
 **/
void linphone_call_set_user_pointer(
    LinphoneCall *call, void *user_pointer)
{
 ...
 **/
LinphoneCallLog *linphone_call_get_call_log(
    const LinphoneCall *call)
{
    return call->log;
}
 ...
 **/
const char *linphone_call_get_refer_to(
    const LinphoneCall *call)
{
 ...
 **/
const char *linphone_call_get_remote_user_agent(
    LinphoneCall *call)
{
    if (call->op)
    {
 ...
 **/
const char *linphone_call_get_remote_contact(
    LinphoneCall *call)
{
    if (call->op)
    {
 ...
 **/
bool_t linphone_call_has_transfer_pending(
    const LinphoneCall *call)
{
 ...
 **/
int linphone_call_get_duration(
    const LinphoneCall *call)
{
 ...
 **/
LinphoneCall *linphone_call_get_replaced_call(
    LinphoneCall *call)
{
 ...
 **/
void linphone_call_enable_camera(
    LinphoneCall *call, bool_t enable)
{
#ifdef VIDEO_ENABLED
 ...
 **/
void linphone_call_send_vfu_request(
    LinphoneCall *call)
{
 ...
 **/
int linphone_call_take_video_snapshot(
    LinphoneCall *call, const char *file)
{
#ifdef VIDEO_ENABLED
 ...
 **/
bool_t linphone_call_camera_enabled(
    const LinphoneCall *call)
{
...
void linphone_call_params_enable_video(
    LinphoneCallParams *cp, bool_t enabled)
{
 ...
 **/
const PayloadType *linphone_call_params_get_used_audio_codec(
 ...
 **/
const PayloadType *linphone_call_params_get_used_video_codec(
    const LinphoneCallParams *cp)
{
 ...
 */
bool_t linphone_call_params_low_bandwidth_enabled(
    const LinphoneCallParams *cp)
{
 ...
 *
 **/
void linphone_call_params_enable_low_bandwidth(
    LinphoneCallParams *cp, bool_t enabled)
{
 ...
 **/
bool_t linphone_call_params_video_enabled(
    const LinphoneCallParams *cp)
{
    return cp->has_video;
}
 ...
 **/
enum LinphoneMediaEncryption linphone_call_params_get_media_encryption(
    const LinphoneCallParams *cp)
{
 ...
 **/
void linphone_call_params_set_media_encryption(
    LinphoneCallParams *cp, enum LinphoneMediaEncryption e)
{
 ...
 **/
void linphone_call_params_enable_early_media_sending(
    LinphoneCallParams *cp, bool_t enabled)
{
 ...
 **/
bool_t linphone_call_params_local_conference_mode(
    const LinphoneCallParams *cp)
{
 ...
 **/
void linphone_call_params_set_audio_bandwidth_limit(
    LinphoneCallParams *cp, int bandwidth)
{
    cp->audio_bw = bandwidth;
}

void linphone_call_params_add_custom_header(
    LinphoneCallParams *params, const char *header_name, const char *header_value)
{
    params->custom_headers = sal_custom_header_append(params->custom_headers, header_name, header_value);
}

const char *linphone_call_params_get_custom_header(
    const LinphoneCallParams *params, const char *header_name)
{
    return sal_custom_header_find(params->custom_headers, header_name);
}

void _linphone_call_params_copy(
    LinphoneCallParams *ncp, const LinphoneCallParams *cp)
{
...
void linphone_call_params_uninit(
    LinphoneCallParams *p)
{
 ...
 **/
void linphone_call_params_destroy(
    LinphoneCallParams *p)
{
...
static void rendercb(
    void *data, const MSPicture *local, const MSPicture *remote)
{
...
#ifdef VIDEO_ENABLED
static void video_stream_event_cb(
    void *user_pointer, const MSFilter *f, const unsigned int event_id, const void *args)
{
...
void linphone_call_set_next_video_frame_decoded_callback(
    LinphoneCall *call, LinphoneCallCbFunc cb, void *user_data)
{
...
void linphone_call_init_audio_stream(
    LinphoneCall *call)
{
    LinphoneCore        *lc = call->core;
...
void linphone_call_init_video_stream(
    LinphoneCall *call)
{
#ifdef VIDEO_ENABLED
    LinphoneCore *lc = call->core;
...
void linphone_call_init_media_streams(
    LinphoneCall *call)
{
...
static void linphone_core_dtmf_received(
...
static void parametrize_equalizer(
    LinphoneCore *lc, AudioStream *st)
{
    if (st->equalizer)
    {
...
void _post_configure_audio_stream(
    AudioStream *st, LinphoneCore *lc, bool_t muted)
{
...
static void post_configure_audio_streams(
    LinphoneCall *call)
{
...
static RtpProfile *make_profile(
    LinphoneCall *call, const SalMediaDescription *md, const SalStreamDescription *desc, int *used_pt)
{
    int                      bw;
    const MSList             *elem;
...
static bool_t linphone_call_sound_resources_available(
    LinphoneCall *call)
{
    LinphoneCore *lc      = call->core;
...
static void linphone_call_start_audio_stream(
    LinphoneCall *call, const char *cname, bool_t muted, bool_t send_ringbacktone, bool_t use_arc)
{
    LinphoneCore               *lc            = call->core;
    int                        used_pt        = -1;
...
static void linphone_call_start_video_stream(
    LinphoneCall *call, const char *cname, bool_t all_inputs_muted)
{
#ifdef VIDEO_ENABLED
    LinphoneCore               *lc            = call->core;
    int                        used_pt        = -1;
...
void linphone_call_start_media_streams(
    LinphoneCall *call, bool_t all_inputs_muted, bool_t send_ringbacktone)
{
    LinphoneCore               *lc      = call->core;
...
void linphone_call_stop_media_streams_for_ice_gathering(
    LinphoneCall *call)
{
...
void linphone_call_delete_ice_session(
    LinphoneCall *call)
{
    if (call->ice_session != NULL)
    {
...
#ifdef BUILD_UPNP
void linphone_call_delete_upnp_session(
    LinphoneCall *call)
{
    if (call->upnp_session != NULL)
    {
...
static void linphone_call_log_fill_stats(
    LinphoneCallLog *log, MediaStream *st)
{
...
void linphone_call_stop_audio_stream(
    LinphoneCall *call)
{
    if (call->audiostream != NULL)
    {
...
void linphone_call_stop_video_stream(
    LinphoneCall *call)
{
#ifdef VIDEO_ENABLED
    if (call->videostream != NULL)
...
void linphone_call_enable_echo_cancellation(
    LinphoneCall *call, bool_t enable)
{
...
bool_t linphone_call_echo_cancellation_enabled(
    LinphoneCall *call)
{
    if (call != NULL && call->audiostream != NULL && call->audiostream->ec)
    {
...
void linphone_call_enable_echo_limiter(
    LinphoneCall *call, bool_t val)
{
...
bool_t linphone_call_echo_limiter_enabled(
    const LinphoneCall *call)
{
    if (call != NULL && call->audiostream != NULL)
    {
 ...
 **/
float linphone_call_get_play_volume(
    LinphoneCall *call)
{
    AudioStream *st = call->audiostream;
    if (st && st->volrecv)
    ...
    LinphoneCall *call)
{
    ...
    else if (audio_rating < 0)
        result = video_rating * 5.0;
    else if (video_rating < 0)
        result = audio_rating * 5.0;
...
static void update_local_stats(
    LinphoneCallStats *stats, MediaStream *stream)
{
 ...
 **/
const LinphoneCallStats *linphone_call_get_audio_stats(
    LinphoneCall *call)
{
 ...
 **/
const LinphoneCallStats *linphone_call_get_video_stats(
    LinphoneCall *call)
{
 ...
 **/
void linphone_call_params_set_record_file(
    LinphoneCallParams *cp, const char *path)
{
    if (cp->record_file)
    {
 ...
 **/
const char *linphone_call_params_get_record_file(
    const LinphoneCallParams *cp)
{
 ...
 **/
void linphone_call_start_recording(
    LinphoneCall *call)
{
    if (!call->params.record_file)
    {
 ...
 * Stop call recording.
 **/
void linphone_call_stop_recording(
    LinphoneCall *call)
{
    if (call->audiostream && !call->params.in_conference)
    {
...
static void report_bandwidth(
    LinphoneCall *call, RtpSession *as, RtpSession *vs)
{
...
static void handle_ice_events(
    LinphoneCall *call, OrtpEvent *ev)
{
...
void linphone_call_background_tasks(
    LinphoneCall *call, bool_t one_second_elapsed)
{
    if (call != NULL)
    {
        LinphoneCore *lc = call->core;
        ...
        if (call->videostream != NULL)
        {
            ...
            while (call->videostream_app_evq && (NULL != (ev = ortp_ev_queue_get(call->videostream_app_evq))))
            {
                OrtpEventType evt = ortp_event_get_type(ev);
                OrtpEventData *evd = ortp_event_get_data(ev);
                ms_warning("ortp_ev_queue_get: evt: %d", evt);
...
void linphone_call_log_completed(
    LinphoneCall *call)
{
    LinphoneCore *lc = call->core;
...
LinphoneCallState linphone_call_get_transfer_state(
    LinphoneCall *call)
{
    return call->transfer_state;
}

void linphone_call_set_transfer_state(
 ...
 **/
bool_t linphone_call_is_in_conference(
    const LinphoneCall *call)
{
 ...
 **/
void linphone_call_zoom_video(
    LinphoneCall *call, float zoom_factor, float *cx, float *cy)
{
