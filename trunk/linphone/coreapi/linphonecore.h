...
/** Callback prototype */
typedef void (*NetworkQualityMonitor)(struct _LinphoneCore *lc, int ms);
/** Callback prototype */
typedef void (*MediaQualityMonitor)(struct _LinphoneCore *lc, int jitter, float packet_lost);
/**
...
bool_t linphone_core_record_enabled(const LinphoneCore *lc);
void linphone_core_enable_record(LinphoneCore *lc, bool_t val);
