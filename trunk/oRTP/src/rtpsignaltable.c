...
int rtp_signal_table_add(
    RtpSignalTable *table, RtpCallback cb, unsigned long user_data)
{
    int i;
...
void rtp_signal_table_emit2(
    RtpSignalTable *table, unsigned long arg)
{
    int i, c;
...
void rtp_signal_table_emit3(
    RtpSignalTable *table, unsigned long arg1, unsigned long arg2)
{
    int i, c;
...
int rtp_signal_table_remove_by_callback(
