...
void jitter_control_enable_adaptive(
    JitterControl *ctl, bool_t val)
{
    ctl->adaptive = val;
}

void jitter_control_set_payload(
    JitterControl *ctl, PayloadType *pt)
{
    ctl->jitt_comp_ts       =
...
void jitter_control_dump_stats(
    JitterControl *ctl)
{
...
void jitter_control_update_corrective_slide(
    JitterControl *ctl)
{
    int tmp;
...
void jitter_control_update_size(
    JitterControl *ctl, queue_t *q)
{
 ...
 */
void jitter_control_new_packet(
...
float jitter_control_compute_mean_size(
    JitterControl *ctl)
{
...
bool_t rtp_session_jitter_buffer_enabled(
    const RtpSession *session)
{
    return session->rtp.jittctl.enabled;
}

void rtp_session_set_jitter_buffer_params(
    RtpSession *session, const JBParameters *par)
{
...
void rtp_session_get_jitter_buffer_params(
    RtpSession *session, JBParameters *par)
{
