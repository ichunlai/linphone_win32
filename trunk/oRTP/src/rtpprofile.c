...
int rtp_profile_find_payload_number(
    RtpProfile *profile, const char *mime, int rate, int channels)
{
    int         i;
    PayloadType *pt;
    for (i = 0; i < RTP_PROFILE_MAX_PAYLOADS; i++)
...
PayloadType *rtp_profile_find_payload(
    RtpProfile *prof, const char *mime, int rate, int channels)
{
    int i;
...
PayloadType *rtp_profile_get_payload_from_mime(
    RtpProfile *profile, const char *mime)
{
    int pt;
 ...
 *
 **/
void rtp_profile_set_payload(
    RtpProfile *prof, int idx, PayloadType *pt)
{
 ...
 *
 **/
void rtp_profile_set_name(
    RtpProfile *obj, const char *name)
{
...
RtpProfile *rtp_profile_clone_full(
    RtpProfile *prof)
{
    if (prof != NULL)
    {
